// Code from the Freenove tutorial for the arduino starter kit
...
void loop() {
  ...
  //Serial.print("Ping: ");
  Serial.println(getSonar()); // Send ping, get distance in cm and print result (0 = outside set distance range)
  //Serial.println("cm");
}
